...
public class BookController {
    ...
    public ResponseEntity<PageResponse<BookDTO>> searchBooks(
            ...
            @RequestParam(defaultValue = "cretedAt") String sortBy,
    ...
    public static class BookStatsResponse{
        public long totalActiveBook;
        public long totalAvailableBooks;

        public BookStatsResponse(long totalActiveBook,long totalAvailableBooks){
            this.totalActiveBook=totalActiveBook;
